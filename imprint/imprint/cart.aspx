<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cart.aspx.cs" Inherits="imprint.cart" %>
						...
						<table class="table table-striped">
							...
							<tbody>
								<tr>
									...
									<td><a href="product_detail.aspx"><img alt="" src="themes/images/ladies/9.jpg"></a></td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="product_detail.aspx"><img alt="" src="themes/images/ladies/1.jpg"></a></td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="product_detail.aspx"><img alt="" src="themes/images/ladies/3.jpg"></a></td>
