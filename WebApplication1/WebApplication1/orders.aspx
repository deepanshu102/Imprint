...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
		 ...
		 <% if (Session["user"] != null)
    {
        ...
        { %>
            <div>
                      <center> 
             OrderId:-<asp:TextBox ID="Order_Box" runat="server"></asp:Textbox><asp:ImageButton ID="Category"  runat="server"  ImageUrl="~/img/search.png" Height="40px" ImageAlign="AbsBottom" Width="40px" ></asp:ImageButton>
               <hr/>
                <asp:Label ID="Status1" runat="server" Text=""></asp:Label>
               <hr />
            <asp:GridView  AutoPostBack="true" ID="Grid_Order" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="cat_id"
              AutoColumnGenrated="false" ShowHeaderWhenEmpty="True"   
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Date">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("odate") %>'></asp:Label>
                        </ItemTemplate>
